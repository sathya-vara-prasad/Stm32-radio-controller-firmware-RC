...
__ALIGN_BEGIN static uint8_t HID_JOYSTICK_ReportDesc[HID_JOYSTICK_REPORT_DESC_SIZE]   __ALIGN_END =
{
		 0x05, 0x01,        // Usage Page (Generic Desktop)
		    0x09, 0x05,        // Usage (Game Pad) - CHANGED from 0x04 for Android compatibility
		    0xA1, 0x01,        // Collection (Application)

		    0x85, 0x01,        // Report ID (1) - CRITICAL for Android
		    ...
		    0x09, 0x35,        //   Usage (Rz)
			 ...
			 0x09, 0x33,        //   Usage (Rx) - Pot 1
			    0x09, 0x34,        //   Usage (Ry) - Pot 2
			   // 0x09, 0x36,        //   Usage (Slider) - Pot 3

		    0x15, 0x81,        //   Logical Minimum (-127)
		    0x25, 0x7F,        //   Logical Maximum (127)
		    0x75, 0x08,        //   Report Size (8 bits)
		    0x95, 0x06,        //   Report Count (4 axes)
		...
		// HID Interface callback structure
